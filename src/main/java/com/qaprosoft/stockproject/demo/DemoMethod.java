...
public class DemoMethod {
	...
	public static void changeQuantity(Report report) { //usedItems - лист вещей, которые загрузили в транспорт
		StockHasItemService shis = new StockHasItemService();
		List<Item> usedItems = report.getItems();
		ArrayList<StockHasItem> itemByStockID1 = shis.getItemAndQuantityByStockId(report.getStock1().getId());
...
//						shis.updateItemInStock(stockId1, itemByStockID1.get(j));
						shis.updateItemInStock(report.getStock1().getId(), itemByStockID1.get(j).getItem().getId(), tempQuantity);
		...
		ArrayList<StockHasItem> itemByStockID2 = shis.getItemAndQuantityByStockId(report.getStock1().getId());
		for (int i = 0; i < usedItems.size(); i++) {
...
//					shis.updateItemInStock(stockId2, itemByStockID2.get(j));
					shis.updateItemInStock(report.getStock2().getId(), itemByStockID2.get(j).getItem().getId(), tempQuantity);
					logger.log(Level.INFO, "Entry in DataBase was change");
				} else {
					StockHasItem shi = new StockHasItem();
					shi.setItem(usedItems.get(i));
					shi.setQuantity(1);
					shis.insertNewItemInStock(report.getStock2().getId(), shi);
...
//	public static void changeQuantity(Long stockId1, Long stockId2, ArrayList<Item> usedItems) { //usedItems - лист вещей, которые загрузили в транспорт
//		StockHasItemService shis = new StockHasItemService();
...
//						itemByStockID1.get(j).setQuantity(tempQuantity);
////						shis.updateItemInStock(stockId1, itemByStockID1.get(j));
//						shis.updateItemInStock(stockId1, itemByStockID1.get(j).getItem().getId(), tempQuantity);
//						
//						logger.log(Level.INFO, "Entry in DataBase was updated");
//						break;
//					}
...
//					itemByStockID2.get(j).setQuantity(tempQuantity);
////					shis.updateItemInStock(stockId2, itemByStockID2.get(j));
//					shis.updateItemInStock(stockId1, itemByStockID2.get(j).getItem().getId(), tempQuantity);
//					logger.log(Level.INFO, "Entry in DataBase was change");
//				} else {
//					StockHasItem shi = new StockHasItem();
//					shi.setItem(usedItems.get(i));
